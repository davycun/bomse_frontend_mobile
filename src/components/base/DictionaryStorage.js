import Vue from 'vue';
import {Checkbox, Radio, Toast} from "vant";
...
//                     {
//                         dicS.map((dic) => {
//                             return <Radio.RadioItem key={dic.code} value={dic.code}>{dic.name}</Radio.RadioItem>
//                         })
//                     }
//                 </Radio>
//             );
...
//                     {
//                         dicS.map((dic) => {
//                             return <Checkbox.CheckboxItem key={dic.code} value={dic.code}>{dic.name}</Checkbox.CheckboxItem>
//                         })
//                     }
//                 </Checkbox>
//             );
...
DictionaryStorage.prototype.init = function (callback) {
    request({
        conf: {
            ...
            data: {
                // key:'com.cii.bomse.hrm.emp.dictionary.EducationType'
            },
        },
        success: (data) => {
            if (data.result) {
